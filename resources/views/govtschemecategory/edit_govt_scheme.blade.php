		...
		<div class="content">
			<div class="page-header">
				<div class="page-title">
					<h4>Edit Government Scheme</h4>
				</div>
			</div>
			<div class="card">
				<div class="card-body">
					<form method="post" action="{{route('UpdateGovtScheme')}}" enctype="multipart/form-data">
                        @csrf    
                            ...
                            <div class="col-lg-4 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="select" name="category_id" required>
                                        ...
                                        <option value="{{$value->id}}" {{ $single_data->category_id == $value->id ? 'selected' : '' }}>{{$value->scheme_category}}</option>
                                        @endforeach
                                    </select>
                                        @error('category_id')
