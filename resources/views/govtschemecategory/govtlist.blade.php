...
@include('layouts.sidemenu')
	<div class="page-wrapper">
		...
		<div class="page-header">
			...
			<div class="page-btn">
				<a href="/AddGovtScheme" class="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" class="me-1">Add New</a>
			</div>
		</div>
		<div class="card">
			<div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="me-3" href="GovtSchemedestroy/{{$value->id}}">
