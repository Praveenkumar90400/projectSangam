...
<div class="col-lg-12 col-ml-12 padding-bottom-30">
    <div class="row">
        ...
        <h4 class="header-title">{{__('Company')}}</h4>
                                        ...
                                        <div class="modal-body">
                                            <form action="#" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name" id="name" placeholder="Enter Company email">
                                                </div>
                                                <div class="form-group">
                                                    <label for="latitude">Registration Number</label>
                                                    <input type="text" class="form-control" name="latitude" id="latitude" placeholder="Enter Registration Number">
                                                </div>
                                                <div class="form-group">
                                                    <label for="longitude">Company Type</label>
                                                    <input type="text" class="form-control" name="longitude" id="longitude" placeholder="Enter Company Type">
                                                </div>
                                                <div class="form-group">
