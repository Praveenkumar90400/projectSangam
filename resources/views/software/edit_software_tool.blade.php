...
.form-control.error {
    ...
    <div class="page-wrapper">
		<div class="content">
			...
			<div class="card">
				<div class="card-body">
					<form method="post" action="{{route('UpdateSoftwareTools')}}" enctype="multipart/form-data">
                        @csrf    
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="select" name="category_id" required>
                                        ...
                                        <option value="{{$value->id}}" {{ $single_data->category_id == $value->id ? 'selected' : '' }}>{{$value->category_name}}</option>
                                        @endforeach
                                    </select>
                                        @error('category_id')
                            ...
                            <div class="col-lg-4 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-groupicon">
                                        <input type="text" name="owner" value="{{$single_data->owner}}" class="form-control @error('owner')is-invalid @enderror" required>
                                        @error('owner')
                                        <span class="error" style="color:#842029;">{{ $message }}</span>
                                        @enderror 
                                    </div>
